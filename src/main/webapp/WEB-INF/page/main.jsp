...
<div region="center">
    <div class="easyui-tabs" fit="true" border="false" id="tabs">
        <div title="首页" data-options="iconCls:'icon-home'">
            <div align="center" style="padding-top: 100px"><font color="red" size="10">欢迎管理员使用</font></div>
        </div>
    </div>
</div>
    ...
    <div class="easyui-accordion" data-options="fit:true,border:false">
        ...
        <div title="教师管理" data-options="iconCls:'icon-fwgl'" style="padding:10px">
          ...
          <div title="系统管理"  data-options="iconCls:'icon-item'" style="padding:10px">
            <a href="javascript:openTab('个人信息管理','adminManage?userid=${currentUser.userid }','icon-khxxgl')" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-fwgd'" style="width: 150px;">个人信息管理</a>
