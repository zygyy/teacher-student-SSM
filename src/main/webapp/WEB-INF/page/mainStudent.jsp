    ...
    <script type="text/javascript">
        ...
        function openTab(text,url,iconCls){
            if($("#tabs").tabs("exists",text)){/*若tabs已打开*/
                ...
                var content="<iframe frameborder=0 scrolling='auto' style='width:100%;height:100%' src='${pageContext.request.contextPath}/student/"+url+"'></iframe>";
                $("#tabs").tabs("add",{
                    title:text,
                    iconCls:iconCls,
                    closable:true,
...
<div region="center">
    <div class="easyui-tabs" fit="true" border="false" id="tabs">
        <div title="首页" data-options="iconCls:'icon-home'">
            <div align="center" style="padding-top: 100px"><font color="pink" size="10">欢迎学生使用</font></div>
        </div>
    </div>
</div>
